...
const Game = () => {
  ...
  return (
    <div className="flex flex-col h-screen    mx-auto   bg-transparent  rounded-md items-center justify-center">
       ...
       <ToastContainer 
        ...
        pauseOnHover
      />
  <div className=' bg-orange-50 bg-opacity-50 rounded-3xl max-w-xl  max-h-xl p-5 sm:p-5 border-t-2 border-green-600  shadow-xl justify-center'>
